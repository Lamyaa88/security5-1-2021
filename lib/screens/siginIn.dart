...
//                    ),
              //===================================================================================================================================
              heightSizedBox(context, .02),
              radiusContainer(context, 'الاسم', 15, false, _nameController),
              heightSizedBox(context, .02),
              heightSizedBox(context, .01),
              radiusContainer(
                  context, 'البريد الإلكتروني', 15, false, _emailController),
              heightSizedBox(context, .02),
              heightSizedBox(context, .02),
              radiusContainer(
                  context, 'رقم الجوال', 15, false, _mobileController),
              heightSizedBox(context, .02),
              heightSizedBox(context, .01),
              radiusContainer(
                  context, 'كلمة المرور', 15, true, _passwordController),
              heightSizedBox(context, .02),
