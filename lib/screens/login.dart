...
//                    ),
              Row(
                ...
                children: <Widget>[
                  ...
                  myText('تسجيل الدخول', whiteColor, 20),
              ...
              heightSizedBox(context, .02),
              radiusContainer(
                  context, ' البريد الالكتروني ', 15, false, emailController),

              heightSizedBox(context, .02),
              heightSizedBox(context, .01),
              radiusContainer(
                  context, ' كلمة المرور', 15, true, passwordController),
              heightSizedBox(context, .02),
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  myCircularAvatar(20, 'assets/facebook.png', () {
                    Navigator.push(
                        context, SlideFromLeftPageRoute(widget: SocialMedia1()));}),
                  widthSizedBox(context, .1),
                  myCircularAvatar(20, 'assets/google.png', () {
                    Navigator.push(
                        context, SlideFromTopRoute(widget: SignInWithGooogle()));
                  }),
                  widthSizedBox(context, .1),
                  myCircularAvatar(20, 'assets/twitter.png', () {
                    Navigator.push(
                        context, SlideFromRightPageRoute(widget: TwitterLoginScreen()));
                  }),
                ],
              ),
              heightSizedBox(context, .02),
